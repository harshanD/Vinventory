...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 06, 2020 at 06:33 PM
...
ALTER TABLE `adjustment`
  ...
  ADD KEY `reference_code` (`reference_code`,`date`,`deleted_at`,`status`) USING BTREE;
...
ALTER TABLE `biller`
  ...
  ADD KEY `id` (`id`,`status`,`deleted_at`) USING BTREE;
...
ALTER TABLE `invoice`
  ...
  ADD KEY `invoice_code` (`invoice_code`,`location`,`biller`,`customer`,`invoice_date`,`status`,`deleted_at`) USING BTREE;
...
ALTER TABLE `invoice_details`
  ...
  ADD KEY `invoice_id` (`invoice_id`,`item_id`);
...
ALTER TABLE `payments`
  ...
  ADD KEY `reference_code` (`reference_code`,`parent_reference_code`,`deleted_at`);
...
ALTER TABLE `po_details`
  ...
  ADD KEY `po_header` (`po_header`,`item_id`);
...
ALTER TABLE `po_header`
  ...
  ADD KEY `location` (`location`,`supplier`,`referenceCode`,`status`,`deleted_at`);
...
ALTER TABLE `products`
  ...
  ADD KEY `id` (`id`,`category`,`brand`,`status`,`deleted_at`);
...
ALTER TABLE `stock`
  ...
  ADD KEY `po_reference_code` (`po_reference_code`,`receive_code`,`location`,`status`,`deleted_at`);
...
ALTER TABLE `stock_items`
  ...
  ADD KEY `stock_id` (`stock_id`,`item_id`,`qty`,`cost_price`,`method`);
...
ALTER TABLE `stock_return`
  ...
  ADD KEY `return_reference_code` (`return_reference_code`,`location`,`date`,`biller`,`customer`,`status`,`deleted_at`);
...
ALTER TABLE `stock_return_details`
  ...
  ADD KEY `return_id` (`return_id`,`item_id`);
...
ALTER TABLE `supplier`
  ...
  ADD KEY `id` (`id`,`status`,`deleted_at`);
...
ALTER TABLE `transfers`
  ...
  ADD KEY `tr_reference_code` (`tr_reference_code`,`receive_code`,`from_location`,`to_location`,`status`,`deleted_at`);
...
ALTER TABLE `users`
  ...
  ADD KEY `email` (`email`,`status`,`deleted_at`);
