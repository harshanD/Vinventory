...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/billers/manage')}}">Manage Billers</a></li>
        <li class="active">Edit Billers</li>
    </ol>
@stop
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status" id="status">
                                        <option value="0" {{ (old("status")== 0||$biller->status == 0? "selected":"") }}>
                                            Active
                                        </option>
                                        <option value="1" {{ (old("status")== 1||$biller->status == 1? "selected":"") }}>
                                            Inactive
                                        </option>
                                    </select>
                                </div>
