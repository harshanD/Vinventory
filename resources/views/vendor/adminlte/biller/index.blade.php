...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="active">Manage Billers</li>
    </ol>
@stop
...
@section('content')
    ...
    <section class="content">
        ...
        <!-- remove supplier modal -->
        <div class="modal fade" tabindex="-1" role="dialog" id="deleteBillerModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
    ...
    <script type="text/javascript">
        ...
        function itemDetails(id) {
            $.ajax('/biller/fetchPOItemsDataById', {
        ...
        function deleteBiller(id) {
            $('#deleteBillerModal').modal({
                hidden: 'true'
            });

            $('#deleteBtn').attr("href", ('/biller/delete/') + id);
        }
