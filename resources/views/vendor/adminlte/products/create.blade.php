                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('product_name') }}" class="form-control" id="product_name" name="product_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('product_code') }}" class="form-control" id="product_code" name="product_code"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('sku') }}" class="form-control" id="sku" name="sku" placeholder="Enter sku"
                                           autocomplete="off"/>
                                    @error('sku')
                                    <p class="help-block">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('secondary_name') }}" class="form-control" id="secondary_name" name="secondary_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('cost') }}" class="form-control" id="cost" name="cost"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tax_activation" id="tax_activation">
                                        <option value="1" {{ (old("tax_activation") == 1? "selected":"") }}>Exclusive</option>
                                        <option value="2" {{ (old("tax_activation") == 2? "selected":"") }}>Inclusive</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text"  class="form-control" id="description" name="description"
                                              placeholder="Enter description" autocomplete="off">{{ old('description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                            <span class="input-group-addon">
                                              <input type="checkbox" {{ (old("reorder_activate") == 1? "checked":"") }} name="reorder_activate" id="reorder_activate">
                                            </span>
                                        <input type="text" value="{{ old('reorder_level') }}" class="form-control" name="reorder_level"
