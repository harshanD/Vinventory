...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li ><a href="{{url('/reports/suppliers')}}"> Supplier Report</a></li>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $header['totPur'] }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
                ...
                <div class="box-body">
                    <div class="nav-tabs-custom  <?= $table_responsive ?>">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab">Purchases</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_2">
                                ...
                                <table class="table table-hover" id="paymentManageTable">
                                    ...
                                    <th align="center">Purchase Reference</th>
...
@section('js')
    <script>
        ...
        var imageSaveName = 'suppliers__';

        function getXlsSales() {
            $("#manageTable").table2excel({
                exclude: ".noExl",
                name: "Worksheet Name",
                filename: imageSaveName + '_purchases',
                fileext: ".xls",
                exclude_img: false,
                exclude_links: true,
                exclude_inputs: true
        ...
        var supplierId = pageURL.substr(pageURL.lastIndexOf('/') + 1);
        ...
        $(document).ready(function () {
            $('#manageTable').DataTable({
                ...
                ajax: {
                    "type": 'POST',
                    "url": '/reports/fetchSuppliersPurData',
                    "data": {
                        '_token': '{{@csrf_token()}}',
            ...
            $('#paymentManageTable').DataTable({
                ...
                ajax: {
                    "type": 'POST',
                    "url": '/reports/fetchSuppliersPaymentData',
                    "data": {
                        '_token': '{{@csrf_token()}}',
                        'supplierId': supplierId,
                    }
