...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="active">Daily Purchases Report</li>
    </ol>
@stop
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Daily Purchases Report</h3>
    ...
    <script>
        ...
        var imageSaveName = 'dailyPurchases_()_';
        ...
        $(document).ready(function () {
            $("#search").click(function () {
                $('#drawTable').html('')
                $.ajax('/reports/daily_purchases/' + $('#monthpicker').val(),
                    {
