    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Returns</h3>
            ...
            <form role="form" id="invUpdate" enctype="multipart/form-data"
                  action="{{url('returns/edit/'.$returns->id)}}"
                  method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" placeholder="Select Date" name="datepicker"
                                               value="{{(old('datepicker')=='')?$returns->date:old('datepicker')}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control" name="referenceNo" id="referenceNo"
                                               value="{{(old('referenceNo')=='')?$returns->return_reference_code:old('referenceNo')}}">
                                    </div>
                                    <!-- /.input group -->
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <select class="form-control select2" name="biller" id="biller">
                                            ...
                                            @foreach($billers as $biller)
                                                <option value="{{$biller->id}}" {{ ($returns->biller == $biller->id? "selected":"")}}>{{$biller->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.input group -->
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <select class="form-control select2" name="location" id="location">
                                            ...
                                            @foreach($locations as $location)
                                                <option value="{{$location->id}}" {{ ($returns->location == $location->id? "selected":"")}}>{{$location->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!-- /.input group -->
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <select class="form-control col-xs-4 select2" name="customer" id="customer">
                                            ...
                                            @foreach($customers as $customer)
                                                <option value="{{$customer->id}}" {{ ($returns->customer == $customer->id? "selected":"")}}>{{$customer->name}}</option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <select class="form-control select2" name="wholeTax" id="wholeTax"
                                            ...
                                            @foreach($tax as $ta)
                                                <option value="{{$ta->value}}" {{ ($returns->tax_per == $ta->value? "selected":"")}}>{{$ta->name ."-".$ta->code}}</option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="wholeDiscount"
                                               value="{{ (old('wholeDiscount')!='')?old('wholeDiscount'):$returns->discount_val_or_per}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea type="text" class="form-control" id="returnNote" name="returnNote"
                                                      ...
                                                      autocomplete="off">{{$returns->return_note}}</textarea>
                                        </div>
                                        <!-- /.input group -->
                                        {{--                                        <p class="help-block" id="datepicker_error"></p>--}}
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea type="text" class="form-control" id="staffNote" name="staffNote"
                                                      placeholder="Note"
                                                      autocomplete="off">{{$returns->staff_note}}</textarea>
                                        </div>
                                        <!-- /.input group -->
                                        {{--                                        <p class="help-block" id="datepicker_error"></p>--}}
                                    </div>
    ...
    <script>
        ...
        function itemsQtyVali(id) {
            ...
            if (!$.isNumeric($('#quantity_' + id).val())) {
                ...
                $('#quantity_' + id).val(($('#quantity_' + id).val()).replace(/[^\d.-]/g, ''))
                setTimeout(function () {
