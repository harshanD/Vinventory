...
<div class="container">
    ...
    <h2 align="center">{{config('adminlte.title', 'AdminLTE 2')}} - Returns</h2><br>
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="col-xs-7 pull-right">
                <div class="col-xs-12 text-right order_barcodes">
                    <img src="data:image/png;base64,{{DNS1D::getBarcodePNG($returns->invoice_code, 'C93',1, 70)}}"
                         alt="barcode"/>&nbsp;&nbsp;
            ...
            <div class="col-xs-5">
                ...
                <div class="col-xs-10">
                    <h4 class="">Reference: {{$returns->return_reference_code}}</h4>
        ...
        <div class="row">
            <div class="col-xs-12">
                @if($returns->sale_note!='')
                    <div class="well well-sm">
                        <p>Note: </p>
                        <p>{{$returns->sale_note}} </p>
                    </div>
                @endif
            </div>
        </div>
