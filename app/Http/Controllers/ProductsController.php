    ...
    public function fetchProductsData()
    {
        ...
        return Datatables::of($query)
            ->addColumn('category', function ($query) {
                ...
                return '<a href="' . asset('storage/' . $query->img_url) . '"  class="image-link-custom"><img src="' . asset('storage/' . $query->img_url) . '" class="imgBorder" style="width:50px;height:50px"  alt="placeholder avatar"></a>';
